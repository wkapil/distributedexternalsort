 ...
 * by using the parallel stream sort provided by Java 8.
 * 
 ...
 * 
 * Usage: java com/google/code/externalsorting/ExternalSortParallelStreamSort somefile.txt out.txt
 * 
 * You can change the default maximal number of temporary files with the -t
 * flag: java com/google/code/externalsorting/ExternalSortParallelStreamSort somefile.txt out.txt
 * -t 3
 * 
 * For very large files, you might want to use an appropriate flag to allocate
 * more memory to the Java VM: java -Xms2G
 * com/google/code/externalsorting/ExternalSortParallelStreamSort somefile.txt out.txt
 * 
 ...
 */
public class ExternalSortParallelStreamSort {
	...
	public static void sort(final File input, final File output)
			throws IOException {
		ExternalSortParallelStreamSort.mergeSortedFiles(ExternalSortParallelStreamSort.sortInBatch(input),
				output);
	}
	...
	public static File sortAndSave(List<String> tmplist,
		...
		// Use following sort code upto Java 7
		Collections.sort(tmplist, cmp);
		// Use following sort code for Java 8
